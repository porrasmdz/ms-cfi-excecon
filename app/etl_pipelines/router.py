...
from app.cyclic_count.models import CountRegistry
from app.inventory.schemas import ReadProduct
...
@router.get("/aggregation/", response_model=PaginatedResource[ReadProduct])
